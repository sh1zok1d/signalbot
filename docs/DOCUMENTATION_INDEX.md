...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PREREG.md` | **FROZEN_BEFORE_IMPLEMENTATION** | Outcome-blind synthetic methodology-calibration prereg; not market evidence; does not authorize B2-06 |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PREREG.json` | **FROZEN_BEFORE_IMPLEMENTATION** | Machine-readable twin of the synthetic calibration prereg |
...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_EXECUTION_DRIVER.md` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNEXECUTED** | Canonical 3200-world driver; live ARM authorizes freeze parent; calibration not executed |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_EXECUTION_DRIVER.json` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNEXECUTED** | Machine-readable twin of the armed-unexecuted production execution-driver contract |
...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_DRIVER_FREEZE.json` | **PRODUCTION_DRIVER_IMPLEMENTATION_FROZEN_UNARMED** | Canonical machine-readable driver freeze; live ARM binds this parent artifact |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.md` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNEXECUTED** | Docs-only ARM immediate child of freeze `40e54b8`; authorizes one synthetic 3200-world run; does not execute |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.json` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNEXECUTED / UNUSED** | Canonical machine-readable production Monte Carlo ARM; one-shot; unused after operational abort; does not authorize the performance descendant |
| `research/HARNESS_PERFORMANCE_V1.md` | **PERFORMANCE_EXECUTION_FROZEN_UNARMED / NOT_A_PRODUCTION_RESULT / NOT_AN_ARM** | Performance-only descendant of the synthetic production path; worker TCB pin + durable partial world evidence + checkpoint ≠ scientific authority + parallel isolated verification; freeze parent of the next ARM; does not consume ARM `0abc5fe`; does not execute the 3200-world grid |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PERFORMANCE_EXECUTION_FREEZE.json` | **PERFORMANCE_EXECUTION_FROZEN_UNARMED** | Canonical machine-readable performance/execution freeze of reviewed implementation HEAD `9c573df` / tree `b9d9286`; OPUS `GO_FOR_PERFORMANCE_FREEZE`; freeze itself does not arm; old ARM `0abc5fe` does not authorize this implementation |
