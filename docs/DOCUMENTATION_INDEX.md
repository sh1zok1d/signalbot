...
| `scripts/research/harness_synthetic_edge_calibration_v3_production.py` | **CANONICAL_EXECUTION_PLUMBING / UNRESERVED** | One-shot reservation, durable checkpoint resume, WORLD_RECORDS/RESULT mint; does not redefine frozen science; live reservation not yet created |
