...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_EXECUTION_DRIVER.md` | **PRODUCTION_EXECUTION_DRIVER_IMPLEMENTED_UNARMED** | Canonical 3200-world driver; RESULT mint requires an in-process session capability; Monte Carlo remains unarmed; no live ARM |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_EXECUTION_DRIVER.json` | **PRODUCTION_EXECUTION_DRIVER_IMPLEMENTED_UNARMED** | Machine-readable twin of the unarmed production execution-driver contract |
