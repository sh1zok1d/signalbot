...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_PREREG.md` | **FROZEN_BEFORE_IMPLEMENTATION** | V2 methodology-only candidate identifiability policy; not an ARM; not a production run; does not salvage V1 |
