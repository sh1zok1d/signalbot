...
| `research/HARNESS_PERFORMANCE_V1.md` | **PERFORMANCE_ONLY / NOT_A_PRODUCTION_RESULT / UNARMED / REPAIR_PENDING_OPUS_REVIEW** | Performance-only repair of the synthetic production path; worker TCB pin + durable partial world evidence + checkpoint ≠ scientific authority; does not consume ARM `0abc5fe`; does not execute the 3200-world grid |
