...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.json` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNEXECUTED** | Canonical machine-readable production Monte Carlo ARM for the performance freeze parent; one-shot; unexecuted; unused driver ARM `0abc5fe` does not authorize this implementation |
