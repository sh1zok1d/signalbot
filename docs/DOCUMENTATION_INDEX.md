...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.json` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNUSED** | Parent-authorizing one-shot ARM for freeze HEAD `502a62d`; production calibration not executed; no RESULT |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.md` | **PRODUCTION_MONTE_CARLO_ARM_AUTHORIZED_UNUSED** | Human companion to the unused one-shot production ARM; does not authorize B2-06/2025/2026 |
