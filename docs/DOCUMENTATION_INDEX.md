...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_PREREG_AMENDMENT_001.md` | **FROZEN_BEFORE_IMPLEMENTATION** | Docs-only prospective amendment closing MAJOR-1 and MINOR-1..4; does not implement V2 |
