...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_33_33_POST_WIRING_RUNTIME_FREEZE.md` | **FROZEN_BEFORE_V2_PRODUCTION / CURRENT EXECUTABLE RUNTIME** | Docs freeze of reviewed post-wiring runtime HEAD `c1d6acc` / tree `67f19c99`; verdict `GO_FOR_NEW_IMPLEMENTATION_FREEZE`; historical 33/33 freeze remains valid; not an ARM |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_33_33_POST_WIRING_RUNTIME_FREEZE.json` | **FROZEN_BEFORE_V2_PRODUCTION / CURRENT EXECUTABLE RUNTIME** | Machine-readable post-wiring runtime freeze; binds `c1d6acc` / `67f19c99`, current `production.py` blobs, unchanged inherited ladder, A001/A003/A004, rejected A002, rank-policy freeze, V1 TCB, canonical plan `7fa12fd3…`; does not arm |
