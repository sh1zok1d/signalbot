...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_EXECUTION_DRIVER.md` | **PRODUCTION_EXECUTION_DRIVER_IMPLEMENTED_UNARMED** | Canonical 3200-world driver; live and historical RESULT verifiers; Monte Carlo remains unarmed; no live ARM |
