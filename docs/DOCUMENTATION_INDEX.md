...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_33_33_IMPLEMENTATION_FREEZE.md` | **FROZEN_BEFORE_V2_PRODUCTION** | Docs freeze of reviewed 33/33 implementation HEAD `614295d` / tree `e754b12`; verdict `GO_FOR_IMPLEMENTATION_FREEZE`; Amendment_002 rejected/non-governing; visibility remains fail-closed; not an ARM |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_33_33_IMPLEMENTATION_FREEZE.json` | **FROZEN_BEFORE_V2_PRODUCTION** | Machine-readable 33/33 implementation freeze; binds reviewed commit/tree, implementation blobs, A001/A003/A004, rejected A002, rank-policy freeze, V1 TCB, canonical plan `7fa12fd3…`; does not arm |
