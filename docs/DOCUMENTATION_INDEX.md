...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_VISIBILITY.md` | **VISIBILITY_PLUMBING_AWAITING_INDEPENDENT_REVIEW** | Plumbing to emit frozen V1 `GROUND_TRUTH_VISIBLE` for canonical world identities; does not rerun V2 candidates or mint RESULT |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_VISIBILITY.json` | **VISIBILITY_PLUMBING_AWAITING_INDEPENDENT_REVIEW** | Mechanically bound per-world `GROUND_TRUTH_VISIBLE` evidence; does not modify WORLD_RECORDS |
