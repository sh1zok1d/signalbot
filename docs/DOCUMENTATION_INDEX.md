...
| `RESEARCH_ROADMAP.md` | **ACTIVE / CANONICAL** | Active execution order. MARKET-01 closed `NO_EVIDENCE`; MARKET-03 prereg **frozen** (`FROZEN_OUTCOME_BLIND`); dedicated funding snapshot **ready** (not ARM/execution); V3 closed; no V4; B2-06 remains blocked. |
...
| `research/MARKET_03_FUNDING_SNAPSHOT.md` | **FUNDING_SNAPSHOT_READY / CURRENT FUNDING AUTHORITY** | Dedicated REST funding snapshot wrap; snapshot `d47b7b78…`; not ARM/execution/implementation |
