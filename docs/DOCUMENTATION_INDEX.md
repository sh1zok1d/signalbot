...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_RESULT.json` | **CANONICAL V2 RESULT / MINTED** | Runtime-minted RESULT from authenticated WORLD_RECORDS + visibility; SHA256 `761cc9af…`; frozen mechanical conclusion is the artifact, not a market-edge claim |
