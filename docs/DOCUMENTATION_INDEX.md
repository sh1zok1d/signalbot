...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_EXECUTION_AUTHORIZATION.json` | **AUTHORIZED_FOR_ONE_PRODUCTION_EXECUTION / UNUSED** | Tracked one-shot production authorization; `production_calibration_executed = false` |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_EXECUTION_AUTHORIZATION.md` | **ONE_SHOT AUTHORIZATION / UNUSED** | Human companion to the one-shot authorization JSON |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_AUTHORIZATION_REVIEW.md` | **AUTHORIZATION BOUNDARY REVIEW PACKET** | Packet for adversarial review of the one-shot authorization; not a RESULT |
