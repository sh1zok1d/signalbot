...
| `RESEARCH_ROADMAP.md` | **ACTIVE / CANONICAL** | Active execution order. Next substantive unit: `MARKET-01` implementation of the frozen contract (not execution). V3 closed; no V4; B2-06 remains blocked. |
