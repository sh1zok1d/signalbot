...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_PRODUCTION_ARM.md` | **HISTORICAL ARM / NOT CURRENT LIVE AUTHORITY** | Historical ARM at commit `18ebb4c`; freeze parent `2523b389`; plan `7fa12fd3…`; not present on the control-calibration freeze tree; does not authorize the rebound plan |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_PRODUCTION_ARM.json` | **HISTORICAL ARM / NOT CURRENT LIVE AUTHORITY** | Historical ARM payload at commit `18ebb4c`; canonical plan `7fa12fd3…`; immutable git blob; not live HEAD authority after the control-calibration freeze |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_WORLD_RECORDS.json` | **CANONICAL V2 WORLD_RECORDS / IMMUTABLE HISTORICAL** | Runtime-minted 3200-world evidence at reservation `3bbdf86`; SHA256 `d372eb00…`; blob unchanged; not carried on the control-calibration freeze tree |
...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V2_RANK_DEGENERACY_POLICY_RESULT.json` | **CANONICAL V2 RESULT / MINTED / IMMUTABLE HISTORICAL** | Runtime-minted RESULT from authenticated WORLD_RECORDS + visibility; SHA256 `761cc9af…`; blob unchanged; not carried on the control-calibration freeze tree; do not remint |
