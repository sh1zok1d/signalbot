...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.md` | **HISTORICAL / SUPERSEDED_FOR_REPAIRED_RUNTIME** | Historical ARM of freeze `ccaffe135` / reviewed `9c573df`; does not authorize the repaired runtime freeze of `f47c539` |
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_PRODUCTION_ARM.json` | **HISTORICAL / SUPERSEDED_FOR_REPAIRED_RUNTIME** | ARM of freeze `ccaffe135`; ARM `120ac45` does not authorize the repaired `production.py` freeze |
| `research/HARNESS_PERFORMANCE_V1.md` | **PERFORMANCE_EXECUTION_FROZEN_UNARMED / NOT_A_PRODUCTION_RESULT / NOT_AN_ARM / FINAL_RUNTIME_FREEZE** | Performance-only descendant of the synthetic production path; final runtime freeze of reviewed `f47c539`; freeze parent of the next ARM; does not consume ARM `0abc5fe` or `120ac45`; does not execute the 3200-world grid |
