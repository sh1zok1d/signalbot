...
| `RESEARCH_ROADMAP.md` | **ACTIVE / CANONICAL** | Active execution order. MARKET-01 and MARKET-02 closed `NO_EVIDENCE`; V3 closed; no V4; B2-06 remains blocked. |
...
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_IMPLEMENTATION.md` | **HISTORICAL IMPLEMENTATION UNIT** | Implementation-unit identity; live freeze/ARM/RESULT authority is the freeze, ARM, and RESULT documents |
...
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_ARM.md` | **EXECUTED / CONSUMED** | One-shot MARKET-02 ARM; consumed `1`; unused SHA256 `4cbb2212…` bound into RESULT |
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_ARM.json` | **EXECUTED / CONSUMED** | Consumed ARM twin; unused identity `4cbb2212…`; run identity `4ef6a6c5…` |
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_RESERVATION.json` | **CONSUMED** | Canonical execution reservation consumed `1`; no rerun pre-authorized |
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_RESULT.json` | **CANONICAL RESULT** | Sealed MARKET-02 RESULT; SHA256 `68e084b3…`; `FINAL_CLASSIFICATION = NO_EVIDENCE` |
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_RESULT.md` | **CANONICAL RESULT** | Mechanical restatement of the sealed RESULT; not a stronger claim |
| `research/MARKET_02_OI_EXPANSION_PRICE_CONFIRMATION_CONSUMPTION_LOCK.json` | **CONSUMED** | Pre-evaluate consumption boundary lock; not a scientific RESULT |
| `scripts/research/market_02_oi_expansion_price_confirmation_lib.py` | **EXECUTED / FROZEN** | MARKET-02 scientific pipeline; bound snapshots refuse rerun; scientific functions match reviewed HEAD |
| `scripts/research/market_02_oi_expansion_price_confirmation_authority.py` | **EXECUTED / CONSUMED** | Prereg/freeze/ARM authentication; canonical reservation consumed |
| `scripts/research/market_02_oi_expansion_price_confirmation_canonical_execution.py` | **EXECUTED / ONE-SHOT** | Canonical execution runner; not a second scientific implementation |
