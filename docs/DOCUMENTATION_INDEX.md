...
| `research/HARNESS_SYNTHETIC_EDGE_CALIBRATION_V1_IMPLEMENTATION_REVIEW.md` | **FIXTURE IMPLEMENTATION / EXECUTION UNAUTHORIZED** | Records `implementation_exists = true` while `synthetic_execution_authorized = false` |
