...
bytes, and the unarmed production durability/aggregation layer.
Implementation is frozen. Production execution remains fail-closed until a
separate later arming unit. `production_calibration_executed = false`.
