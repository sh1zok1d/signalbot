...
`FUNDING_HISTORICAL_AVAILABILITY_UNRESOLVED`. Next MARKET-04 step:
`BLOCKED_OBSERVABLE_OR_NEW_CANDIDATE_SELECTION`. Do not invent
publication latency and do not automatically choose another candidate.
