...
RESULT. MARKET-02 is implemented against its frozen prereg and is not
armed, not executed, and not implementation-frozen. Do not design a
...
(`FINAL_CLASSIFICATION = NO_EVIDENCE`). MARKET-02 is implemented
against its frozen prereg and is not armed, not executed, and not
implementation-frozen. Do not rerun MARKET-01.
