...
RESULT. MARKET-03 completed **data acquisition + provenance**
(`READY_FOR_MARKET_03_PREREG_DESIGN`, ceiling `LEVEL_2`). Do not
preregister, ARM, or execute MARKET-03 in the acquisition unit. Do not design a large new MARKET
...
(`FINAL_CLASSIFICATION = NO_EVIDENCE`). MARKET-03 data acquisition is
complete (`READY_FOR_MARKET_03_PREREG_DESIGN`, not preregistered).
