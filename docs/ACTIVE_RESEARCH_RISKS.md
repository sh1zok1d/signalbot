...
| RR-029 | HIGH | **MARKET-05 ETH confirmation treated as an independent ETH experiment, as a direction predictor, as pair-trading, or as another representation of BTC displacement; or CORE_ETH treated as already accepted.** Exact preregistration is now frozen. | Keep BTC as the sole target and ETH as context. Do not threshold-search or change 24h/00:00 UTC/2% gates after outcomes. Do not accept `CORE_ETH_BINANCE_V0` until rematerialized. Do not open protected OOS. Do not describe MARKET-05 as V3-calibrated. |
