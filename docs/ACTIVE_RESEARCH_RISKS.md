...
| RR-026 | HIGH | **MARKET-03 public strategy treated as independently preregistered, as the author's full open-ended `20191001-` headline, or as B2-06 science.** Parameters/BTC focus were selected after the author's 42-strategy/sweep/cross-asset search. Author headline overlaps protected 2025/2026 OOS. CORE is USD-M perpetual; the author trades spot. `fundingTime` is not a proven `legal_available_at`. | Keep MARKET-03 to the frozen prereg **design** until a later unit writes the live prereg. Use truncated authorized `[2019-10-01, 2025-01-01)`. Do not open protected OOS. Do not substitute CORE perp klines. Do not consume B2-06. Do not invent publication latency. |
