...
| RR-029 | HIGH | **MARKET-05 ETH confirmation treated as an independent ETH experiment, as a direction predictor, as pair-trading, or as another representation of BTC displacement; or a pre-ARM freeze treated as ARM/execution.** Current executable freeze is `MARKET_05_FINAL_PRE_ARM_FREEZE`; CORE ETH is accepted as companion identity only. | Keep BTC as the sole target and ETH as context. Do not threshold-search or change 24h/00:00 UTC/2% gates after outcomes. Do not ARM or execute. Do not open protected OOS. Do not describe MARKET-05 as V3-calibrated. |
