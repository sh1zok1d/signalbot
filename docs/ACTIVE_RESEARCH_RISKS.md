...
| RR-025 | HIGH | **MARKET-02 confirmatory test treated as independent replication, V3-calibrated, or proof of no relationship.** MARKET-02 is a sequential same-history follow-up after MARKET-01 `NO_EVIDENCE`, using a new continuation-ratio contrast on the same 2020-09 through 2024-12 window. | Keep `MARKET_02_TEST_CALIBRATED = NO`. Record the sealed `NO_EVIDENCE` RESULT without rescue, rerun, or alternative specification. Do not call it independent replication, causal OI effect, or proof that no relationship exists. |
