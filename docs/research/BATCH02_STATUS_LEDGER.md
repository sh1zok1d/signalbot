...
| `B2-06_LEVERAGE_CROWDING` | F5 | `BLOCKED_MISSING_OBSERVABLE` | OI + funding snapshot Git-bound (`5a9d036b…`); unit verdict `SNAPSHOT_MATERIALIZED_FUNDING_PUBLICATION_UNPROVEN_RESEARCH_UNAUTHORIZED`; funding publication latency unproven; no B2-06 RESULT |
...
| F5 State-mechanism interaction | `BLOCKED_MISSING_OBSERVABLE` | B2-06 snapshot materialized outcome-blind; funding publication unproven; no outcome access |
...
B2_06_DATA_EXPANSION_UNIT_VERDICT = SNAPSHOT_MATERIALIZED_FUNDING_PUBLICATION_UNPROVEN_RESEARCH_UNAUTHORIZED
B2_06_FUNDING_PUBLICATION = FUNDING_PUBLICATION_LATENCY_UNPROVEN
B2_06_DATASET = B2_06_BINANCE_UM_BTCUSDT_OI_FUNDING_V0
B2_06_DATASET_STATUS = SNAPSHOT_MATERIALIZED_NOT_RESEARCH_AUTHORIZED
...
`B2_06_BINANCE_UM_BTCUSDT_OI_FUNDING_V0` now
`SNAPSHOT_MATERIALIZED_NOT_RESEARCH_AUTHORIZED` (snapshot
`5a9d036b23721d75b519b8478b81e333791227376d25cbeea5f0666c90730a33`) and
unit verdict
`SNAPSHOT_MATERIALIZED_FUNDING_PUBLICATION_UNPROVEN_RESEARCH_UNAUTHORIZED`.
Funding `calc_time` is not a proven legal availability clock. Materialized
bytes do not authorize B2-06 outcome access, 2025, 2026, or
