...
The active research phase is **MARKET**. MARKET-01 is **RESULT** / closed under its frozen design (`FINAL_CLASSIFICATION = NO_EVIDENCE`). Do not rerun MARKET-01, change its thresholds, or rescue the sealed classification. MARKET-03 is **source-feasibility only** (`DATA_ACQUISITION_REQUIRED`); do not preregister, ARM, or execute it in this unit, and do not substitute CORE perpetual prices for the author's Binance spot market. Do not design a large new MARKET framework or new infrastructure merely because MARKET continues. Operating priority is approximately 70–80% actual market research and 20–30% infrastructure only when concrete research blockers require it. Primary progress metric: MARKET hypotheses honestly closed per week.
