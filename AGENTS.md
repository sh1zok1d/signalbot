...
The active research phase is **MARKET**. MARKET-01 is **ARMED_NOT_EXECUTED** (implementation frozen; one canonical execution authorized and unused). Do not execute MARKET-01 in an ARM unit. Do not inspect MARKET outcomes. Do not design a large new MARKET framework or new infrastructure merely because MARKET is beginning. Operating priority is approximately 70–80% actual market research and 20–30% infrastructure only when concrete research blockers require it. Primary progress metric: MARKET hypotheses honestly closed per week.
