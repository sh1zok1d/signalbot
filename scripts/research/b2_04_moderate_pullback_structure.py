#!/usr/bin/env python3
"""Canonical B2-04 moderate-pullback-structure runner.
...
from scripts.research.b2_04_moderate_pullback_structure_lib import (
    DATASET_ID,
    DEV_END_MS,
    DEV_START_MS,
    GATE_NAMES,
...
def run_development(
    ...
    *,
    ...
    """Production B2-04 ceremony. Do not invoke against real CORE in this unit.
    ...
    B2-04 one-shot slot on the remote evidence ref before raising. This guard
    ...
    run_context = prepare_batch02_retained_run(
        ...
        command=(
            "python-api",
            "scripts.research.b2_04_moderate_pullback_structure.run_development",
            expected_code_sha,
        ),
    )
